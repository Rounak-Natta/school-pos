        ...
        <section className="space-y-4 border-t border-slate-200 pt-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="space-y-1">
              ...
              <input name="gstRate" type="number" min="0" max="100" step="0.01" defaultValue={selectedVariant?.gstRate.toString() || "0"} required className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-slate-900" />
            </div>

            <div className="space-y-1">
              <label className="text-sm font-medium text-slate-700">HSN Code</label>
              <input name="hsnCode" defaultValue={selectedVariant?.hsnCode || ""} placeholder="Optional" className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-slate-900" />
            </div>
